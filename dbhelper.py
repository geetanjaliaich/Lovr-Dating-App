...
class DBHelper:
    ...
    def register(self, name, email, password, age, gender, city,dp,intro):
        ...
        try:
            ...
            self._mycursor.execute("""
                                                    INSERT INTO users (user_id,name,email,password,age,gender,city,dp,intro)
                                                    VALUES
                                                    (NULL, '{}','{}','{}',{},'{}','{}','{}','{}')
""".format(name, email, password, age, gender, city,dp,intro))
    ...
    def update_info(self, n, a, c, fln, intr, user_id):
        ...
        try:
            self._mycursor.execute("""
                        UPDATE users SET name='{}',age={},city='{}',dp='{}',intro='{}'
                        WHERE user_id LIKE {}""".format(n,a,c,fln,intr, user_id))
            self._conn.commit()
            return 1
        except:
            return 0
